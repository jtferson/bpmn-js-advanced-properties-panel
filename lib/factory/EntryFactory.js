...
var textInputField = require('./TextInputEntryFactory'),
    ...
    buttonField = require('./ButtonFactory'),
    buttonTableField = require('./TableButtonEntryFactory'),
    activityTableField = require("./TableActivityFactory");
...
EntryFactory.buttonTable = function(options){
  return buttonTableField(options);
};

EntryFactory.button = function(options) {
  return buttonField(options);
};

EntryFactory.activityTable = function(options){
  return activityTableField(options);
};
